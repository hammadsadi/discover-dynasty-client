      ...
      <div className="navbar bg-base-100 container mx-auto z-30 ">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 z-50 text-white"
            >
              <li>
                <NavLink
                  to="/"
          ...
          <Link
            to="/"
            className="btn btn-ghost text-xl md:text-2xl font-black text-white flex gap-0"
          >
