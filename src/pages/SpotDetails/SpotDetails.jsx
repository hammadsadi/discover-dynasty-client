                    ...
                    <form className="space-y-6">
                      <div className="space-y-1 text-sm">
                        ...
                        <input
                          ...
                          id="name"
                          placeholder="Name"
                          className="w-full px-4 py-3 rounded-md border border-slate-900/20 focus:border-color-primary transition-all duration-300 text-gray-800 focus:outline-none"
                        />
                      </div>
                      <div className="space-y-1 text-sm">
                        <label
